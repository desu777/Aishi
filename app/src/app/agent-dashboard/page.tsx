            ...
            <div className="commands-modal" style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {/* Consolidation Commands Section */}
                  <CollapsibleSection title="Consolidation Commands" defaultOpen={false}>
                    <div style={{
                      display: 'flex',
                      flexDirection: 'column',
                      gap: 'clamp(8px, 2vw, 12px)'
                      ...
                      />
                      <CommandItem 
                        command="consolidation-status"
                        description="Check consolidation needs and yearly reflection availability"
                        theme={theme}
                      />
                      {process.env.NEXT_PUBLIC_DREAM_TEST === 'true' && (
                        <>
                          <div style={{
                          ...
                          <CommandItem 
                            command="test-mock-monthly"
                            description="Generate monthly mock data for testing consolidation"
                            theme={theme}
                          />
                          <CommandItem 
                            command="test-mock-yearly"
                            description="Generate yearly mock data for testing memory core"
                            theme={theme}
                          />
                          <CommandItem 
                            command="test-consolidation"
                            description="Test monthly consolidation with mock data and real backend"
                            theme={theme}
                          />
                          <CommandItem 
                            command="test-memory-core"
                            description="Test yearly memory core with mock data and real backend"
                            theme={theme}
                          />
                          <CommandItem 
                            command="reset-test"
                            description="Reset test mode state and clear mock data"
                            theme={theme}
                          />
                        </>
                      )}
